...
namespace _11_migrations.Migrations
{
    ...
    [Migration("20240315181842_removeColumn")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("_11_migrations.Airplane", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("_11_migrations.Client", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("_11_migrations.Flight", b =>
                {
            ...
            modelBuilder.Entity("ClientFlight", b =>
                {
                    b.HasOne("_11_migrations.Client", null)
                        .WithMany()
                        .HasForeignKey("ClientsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("_11_migrations.Flight", null)
                        .WithMany()
            ...
            modelBuilder.Entity("_11_migrations.Flight", b =>
                {
                    b.HasOne("_11_migrations.Airplane", "Airplane")
                        .WithMany("Flights")
